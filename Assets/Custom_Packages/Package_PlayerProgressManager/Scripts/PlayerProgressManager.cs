...
namespace PlayerProgressSystem
{
    public class PlayerProgressManager
    {
        ...
        private const string LastStartedMainLevel = "LastStartedMainLevel";
        ...
        private const string LastStartedSubLevel = "LastStartedSubLevel";
        ...
        #region MainLevel
            ...
            public void MainLevelStarted(string mainLevelID)
            {
                ...
                // Set the last Started main level to the current main level
                _storage.SetString(LastStartedMainLevel, mainLevelID);
            ...
            public string GetLastStartedMainLevel()
            {
                // Return the last completed main level
                return _storage.GetString(LastStartedMainLevel, "0");
            }
        ...
        #region Sub Levels
            ...
            public void SubLevelStarted(string subLevelID)
            {
                ...
                _storage.SetString(LastStartedSubLevel, subLevelID);
                // Set the value of the key to 1
            ...
            public string GetLastStartedSubLevel()
            {
                return _storage.GetString(LastStartedSubLevel, "0");
            }
